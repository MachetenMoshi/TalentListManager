 ...
 * @since 2016-03-09
 */
public class JFXedDrawer extends StackPane {
    ...
    private JFXAnimationTimer translateTimer = new JFXAnimationTimer(
                                                                     new JFXKeyFrame(Duration.millis(420),
                                                                                     JFXKeyValue.builder()
                                                                                                ...
                                                                                                .setEndValueSupplier(() -> !hasMiniSize()
                                                                                                                ? 1 - translateTo
                                                                                                                                / initTranslate.get()
                                                                                                                : (resizeTo == getMiniDrawerSize() ? 0
                                                                                                                                : 1))
                                                                     ...
                                                                     new JFXKeyFrame(Duration.millis(420),
                                                                                     JFXKeyValue.builder()
                                                                                                ...
                                                                                                .setAnimateCondition(() -> !hasMiniSize()
    ...
    private void initListeners() {
        ...
        translateProperty.addListener((o, oldVal, newVal) -> {
            if (!openCalled && closeCalled
                            && directionProperty.get().doubleValue() * newVal.doubleValue() > directionProperty.get().doubleValue()
                                            * initTranslate.get() / 2) {
                openCalled = true;
                closeCalled = false;
     ...
     *
     * @param dir
     *        - The direction that the drawer will enter the screen from.
     */
    ...
    public void openInstantly() {
        ...
        resizeTo = getDefaultDrawerSize();
        overlayPane.setMouseTransparent(!isOverLayVisible());
        sidePane.setMinWidth(resizeTo);
        contentHolder.setPadding(new Insets(0, 0, 0, resizeTo));
    }
            ...
            if (directionValue * mouseDiff <= 0) {
                ...
                if (resizable || hasMiniSize()) {
                    ...
                    if (newSize > drawerMinSize) {
                        ...
                        // if the side drawer is not fully shown perform translation to show it , and set its default
                        // size
